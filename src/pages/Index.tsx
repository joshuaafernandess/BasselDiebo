...
import { ArrowRight, MapPin, Phone, Mail, Clock, Calendar, Star, Check, Search } from "lucide-react";
...
import { reviewTranslations } from "@/utils/reviewTranslations";
...
const Index = () => {
  ...
  const reviewT = reviewTranslations[language];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-16">
        ...
        {/* Team Section */}
        <section id="team" className="py-16 px-4 md:px-8 lg:px-16">
          <div className="container mx-auto">
            <div className="text-center mb-12">
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="overflow-hidden relative">
                <CaseImage 
                  src="/Diebo Media/Cases/Case 1.png" 
                  alt="Case 1"
                />
